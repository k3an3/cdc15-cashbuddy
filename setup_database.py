...
t = Transaction.create(user=u, amount=9, dest="Loogle", paid=True, txid="43rtgfb")
t1 = Transaction.create(user=u, amount=500, dest="Safari LLC", paid=True, txid="sfadf23")
t2 = Transaction.create(user=u, amount=17, dest="Coldway Bakery", paid=False, txid="wereufvn")
